...
pub fn NewPostPopup(cx: Scope, hide: UseState<bool>) -> Element {
    ...
    println!("Button class: {}", BUTTON_CLASS); // Debug print
...
pub struct NavButtonProps<'a> {
    ...
    // this is a special case for dioxius
    children: Element<'a>,
}
...
pub fn Navbar(cx: Scope) -> Element {
    ...
    cx.render(rsx! {
        nav {
            ...
            div {
                class: "grid grid-cols-3 justify-around w-full h-gull items-center shadow-inner",
                NavButton {
